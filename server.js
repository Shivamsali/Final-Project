...
let serviceAccount = require("./ecom-website-5caa8-firebase-adminsdk-4l02t-d6e290936b.json");
...
const bucketName = "ecom-website-shivamsali";
...
app.post('/add-product', (req, res) => {
    ...
    if(!draft){
        if(!name.length){
            ...
            return res.json({'alert': 'short description muct be between 10 to 100 leters long'});
        } else if (!des.length){
...
app.post('/order', (req, res) => {
    ...
    const mailOption = {
        from: 'shivamsali81097@gmail.com',
        to: email,
...
<body>
    ...
    let docName = email + Math.floor(Math.random() * 123719287479824);
